<template>
  <div
    class="description order-3 order-sm-3 order-md-3 col-md-4 col-12 text-md-right align-self-end"
  >
    <!-- :style="{ color: `${fontColor[activeProduct.index]}` }" -->
    <h3>{{ activeProduct.model }}</h3>
    <div class="mr-3 ml-3 arrows-container justify-content-around justify-content-md-end">
      <!-- :style="{ color: `${fontColor[activeProduct.index]}` }" -->
